...
about: Summarise an intended discussion, and state assumptions for agreement
title: ''
labels: discussion
assignees: ''
type: Task
...
<!-- Issue title should describe the intended discussion accurately, rather than sound catchy -->
